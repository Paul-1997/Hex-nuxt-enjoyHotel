      ...
      <div class="d-none d-md-block position-relative">
        <div class="d-flex gap-2 rounded-3xl overflow-hidden">
          <div style="width: 52.5vw">
            <img class="w-100" :src="roomDetail.imageUrl" alt="room-a-1" />
          </div>
          <div class="d-flex flex-wrap gap-md-2" style="width: 42.5vw">
            <div class="d-flex gap-md-2" v-for="images in chunkImages(roomDetail.imageUrlList, 2)" :key="images">
              <img v-for="image in images" class="w-50" :src="image" />
            </div>
          </div>
        </div>
        <button
            ...
            <section>
              ...
              <ul class="d-flex gap-4 list-unstyled">
                ...
                <li class="card-info px-4 py-5 bg-neutral-0 border border-primary-40 rounded-3">
                  ...
                  <p class="mb-0 fw-bold text-neutral-80 text-nowrap">{{ roomDetail.bedInfo }}</p>
                </li>
                <li class="card-info px-4 py-5 bg-neutral-0 border border-primary-40 rounded-3">
          ...
          <div class="d-none d-md-block col-md-5">
            ...
            >
              ...
              <div class="text-neutral-80">
                ...
                <p class="mb-0 fw-medium">{{ roomDetail.description }}</p>
              </div>
